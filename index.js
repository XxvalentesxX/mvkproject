...
const { newCommand } = require('./functions/functions/manage_commands/newCommands');
...
const { subCommand, newSlashCommand, slashOption } = require("./functions/functions/manage_commands/slashCommands");
